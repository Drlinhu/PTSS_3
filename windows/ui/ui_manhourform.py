...
class Ui_ManHourForm(object):
    def setupUi(self, ManHourForm):
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/icon/subtask.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButtonSubtask.setIcon(icon4)
        ...
        self.pushButtonAddImage.setIcon(icon5)
        ...
        self.pushButtonImage.setIcon(icon6)
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(":/icon/daily-report.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.toolButtonNrcReportAssistant.setIcon(icon7)
        ...
        self.toolBox.addItem(self.ToolBoxNrc, icon8, "")
        ...
        self.toolButtonRtnReportAssistant.setIcon(icon7)
