...
class Ui_ManHourForm(object):
    def setupUi(self, ManHourForm):
        ...
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap(":/icon/tool.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.toolBox.addItem(self.ToolBoxNrc, icon9, "")
        ...
        self.toolButtonRtnReportAssistant.setIcon(icon8)
