...
class Ui_ProcedureForm(object):
    def setupUi(self, ProcedureForm):
        ...
        self.gridLayout_2.addWidget(self.cbbActionType, 5, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.cbbLocation, 4, 1, 1, 1)
        self.tbvLabel = QtWidgets.QTableView(self.frame_3)
        self.tbvLabel.setEditTriggers(QtWidgets.QAbstractItemView.NoEditTriggers)
        self.tbvLabel.setAlternatingRowColors(True)
        self.tbvLabel.setSelectionMode(QtWidgets.QAbstractItemView.ExtendedSelection)
        self.tbvLabel.setSelectionBehavior(QtWidgets.QAbstractItemView.SelectRows)
        self.tbvLabel.setSortingEnabled(True)
        self.tbvLabel.setObjectName("tbvLabel")
        self.gridLayout_2.addWidget(self.tbvLabel, 9, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.plainTextEditRemark, 10, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.tbvIcw, 8, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.frame_8, 8, 2, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.frame_10, 9, 2, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.plainTextEditAccessDesc, 6, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.frame_9, 11, 0, 1, 3)
        ...
        self.gridLayout_2.addWidget(self.frame_7, 7, 2, 1, 1)
        ...
        self.cbbCraftCode = QtWidgets.QComboBox(self.frame_3)
        self.cbbCraftCode.setObjectName("cbbCraftCode")
        self.cbbCraftCode.addItem("")
        self.cbbCraftCode.setItemText(0, "")
        self.cbbCraftCode.addItem("")
        self.cbbCraftCode.addItem("")
        self.cbbCraftCode.addItem("")
        self.cbbCraftCode.addItem("")
        self.cbbCraftCode.addItem("")
        self.cbbCraftCode.addItem("")
        self.gridLayout_2.addWidget(self.cbbCraftCode, 3, 1, 1, 1)
        ...
        self.toolBoxPageRef.setGeometry(QtCore.QRect(0, 0, 106, 701))
        ...
        self.toolButtonImportFigure = QtWidgets.QToolButton(self.toolBoxPageRef)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.toolButtonImportFigure.sizePolicy().hasHeightForWidth())
        self.toolButtonImportFigure.setSizePolicy(sizePolicy)
        self.toolButtonImportFigure.setIcon(icon1)
        self.toolButtonImportFigure.setIconSize(QtCore.QSize(20, 20))
        self.toolButtonImportFigure.setToolButtonStyle(QtCore.Qt.ToolButtonTextBesideIcon)
        self.toolButtonImportFigure.setAutoRaise(True)
        self.toolButtonImportFigure.setObjectName("toolButtonImportFigure")
        self.verticalLayout_6.addWidget(self.toolButtonImportFigure)
        ...
        self.toolBoxPagePanel.setGeometry(QtCore.QRect(0, 0, 102, 722))
        ...
        self.toolBoxPageIcw.setGeometry(QtCore.QRect(0, 0, 105, 722))
        ...
        self.toolBoxPageLabel = QtWidgets.QWidget()
        self.toolBoxPageLabel.setGeometry(QtCore.QRect(0, 0, 103, 722))
        self.toolBoxPageLabel.setObjectName("toolBoxPageLabel")
        self.verticalLayout_9 = QtWidgets.QVBoxLayout(self.toolBoxPageLabel)
        self.verticalLayout_9.setObjectName("verticalLayout_9")
        self.toolButtonLabelMaint = QtWidgets.QToolButton(self.toolBoxPageLabel)
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap(":/icon/management.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.toolButtonLabelMaint.setIcon(icon9)
        self.toolButtonLabelMaint.setIconSize(QtCore.QSize(20, 20))
        self.toolButtonLabelMaint.setToolButtonStyle(QtCore.Qt.ToolButtonTextBesideIcon)
        self.toolButtonLabelMaint.setAutoRaise(True)
        self.toolButtonLabelMaint.setObjectName("toolButtonLabelMaint")
        self.verticalLayout_9.addWidget(self.toolButtonLabelMaint)
        spacerItem8 = QtWidgets.QSpacerItem(20, 40, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.verticalLayout_9.addItem(spacerItem8)
        self.toolBox.addItem(self.toolBoxPageLabel, icon8, "")
    ...
    def retranslateUi(self, ProcedureForm):
        ...
        self.label_13.setText(_translate("ProcedureForm", "Craft_Code:"))
        self.cbbCraftCode.setItemText(1, _translate("ProcedureForm", "AE"))
        self.cbbCraftCode.setItemText(2, _translate("ProcedureForm", "AV"))
        self.cbbCraftCode.setItemText(3, _translate("ProcedureForm", "CAB"))
        self.cbbCraftCode.setItemText(4, _translate("ProcedureForm", "IN"))
        self.cbbCraftCode.setItemText(5, _translate("ProcedureForm", "PP"))
        self.cbbCraftCode.setItemText(6, _translate("ProcedureForm", "ENG"))
        ...
        self.toolButtonImportFigure.setText(_translate("ProcedureForm", "Figure"))
        ...
        self.toolButtonLabelMaint.setText(_translate("ProcedureForm", "Maint."))
        self.toolBox.setItemText(self.toolBox.indexOf(self.toolBoxPageLabel), _translate("ProcedureForm", "Label"))
import image_rc
