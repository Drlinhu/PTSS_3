...
class Ui_ProcedureForm(object):
    def setupUi(self, ProcedureForm):
        ...
        self.cbbLocation.addItem("")
        self.cbbLocation.setItemText(0, "")
        self.cbbLocation.addItem("")
        self.cbbLocation.addItem("")
        self.cbbLocation.addItem("")
        self.cbbLocation.addItem("")
        ...
        self.btnNewMarker = QtWidgets.QPushButton(self.frame_10)
        self.btnNewMarker.setEnabled(False)
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(10)
        self.btnNewMarker.setFont(font)
        self.btnNewMarker.setText("")
        self.btnNewMarker.setIcon(icon4)
        self.btnNewMarker.setObjectName("btnNewMarker")
        self.verticalLayout_8.addWidget(self.btnNewMarker)
        self.btnDeleteMarker = QtWidgets.QPushButton(self.frame_10)
        self.btnDeleteMarker.setEnabled(False)
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(10)
        self.btnDeleteMarker.setFont(font)
        self.btnDeleteMarker.setText("")
        self.btnDeleteMarker.setIcon(icon3)
        self.btnDeleteMarker.setObjectName("btnDeleteMarker")
        self.verticalLayout_8.addWidget(self.btnDeleteMarker)
        ...
        self.cbbActionType.addItem("")
        self.cbbActionType.setItemText(0, "")
        self.cbbActionType.addItem("")
        self.cbbActionType.addItem("")
        self.cbbActionType.addItem("")
        self.cbbActionType.addItem("")
        ...
        spacerItem8 = QtWidgets.QSpacerItem(20, 427, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
    ...
    def retranslateUi(self, ProcedureForm):
        ...
        self.cbbLocation.setItemText(1, _translate("ProcedureForm", "COCKPIT"))
        self.cbbLocation.setItemText(2, _translate("ProcedureForm", "CABIN"))
        self.cbbLocation.setItemText(3, _translate("ProcedureForm", "CARGO"))
        self.cbbLocation.setItemText(4, _translate("ProcedureForm", "FWD CARGO"))
        self.cbbLocation.setItemText(5, _translate("ProcedureForm", "AFT CARGO"))
        self.cbbLocation.setItemText(6, _translate("ProcedureForm", "FUSELAGE"))
        self.cbbLocation.setItemText(7, _translate("ProcedureForm", "WING"))
        self.cbbLocation.setItemText(8, _translate("ProcedureForm", "LDG"))
        self.cbbLocation.setItemText(9, _translate("ProcedureForm", "EMP"))
        self.label_3.setText(_translate("ProcedureForm", "Description:"))
        self.label_10.setText(_translate("ProcedureForm", "Marker:"))
        self.label_7.setText(_translate("ProcedureForm", "ICW:"))
        self.label_8.setText(_translate("ProcedureForm", "Access_Desc."))
        ...
        self.label_12.setText(_translate("ProcedureForm", "Action_Type"))
        self.cbbActionType.setItemText(1, _translate("ProcedureForm", "INSP"))
        self.cbbActionType.setItemText(2, _translate("ProcedureForm", "CHECK"))
        self.cbbActionType.setItemText(3, _translate("ProcedureForm", "RPL"))
        self.cbbActionType.setItemText(4, _translate("ProcedureForm", "LUB"))
        self.cbbActionType.setItemText(5, _translate("ProcedureForm", "MOD"))
        self.cbbActionType.setItemText(6, _translate("ProcedureForm", "CLN"))
        self.cbbActionType.setItemText(7, _translate("ProcedureForm", "WT"))
        self.cbbActionType.setItemText(8, _translate("ProcedureForm", "ADJT"))
